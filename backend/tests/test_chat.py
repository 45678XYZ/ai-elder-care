...
def test_chat_missing_elder_id():
    """測試缺少 elder_id 回傳 400 INVALID_PARAMETER。"""
...
def test_chat_invalid_lang():
    """測試不符合規範之語言選項回傳 400 INVALID_PARAMETER。"""
...
def test_chat_both_text_and_audio_missing():
    """測試 text 與 audio 皆未提供時回傳 400 INVALID_PARAMETER。"""
...
def test_chat_both_text_and_audio_provided():
    """測試同時提供 text 與 audio 時回傳 400 INVALID_PARAMETER。"""
    event = _make_event({
        "elder_id": "eld_001",
        "lang": "zh-TW",
        "text": "你好",
...
def test_chat_success_text_path(monkeypatch):
    """測試成功的文字對話流程 (200 OK) 且確認雙寫欄位包含 elder_transcript。"""
    event = _make_event({
        "elder_id": "eld_001",
        "lang": "zh-TW",
