...
權威架構見 [`docs/tts/framework.md`](../../../../docs/tts/framework.md)，設定與 container
契約分別見 [`config-schema.md`](../../../../docs/tts/config-schema.md) 與
...
| `router.py` | route 選擇、能力 gate、同語言 fallback |
| `facade.py` | 輸入門檻與單一領域入口 |
