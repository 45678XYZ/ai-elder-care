...
# 2. 建立後端 Lambda 共用 IAM Role (信任 Lambda 服務)
...
# 4. 後端 Lambda 專屬權限政策 (Polly, S3, Bedrock, SageMaker, DynamoDB)
...
# 6. tools Lambda 函數 (Bedrock Action Group 工具箱)
